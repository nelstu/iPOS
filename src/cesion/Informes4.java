          ...
          //Resultset returned by query 
           ...
           while(rs.next()){ 
              ...
              sheet.addCell(new jxl.write.Number(4, j, rs.getInt(5)));
               ...
               BuscarCod=rs.getString(2);
               //buscar Familia
              // String query1 = "select barra,familia from productos WHERE barra='" + BuscarCod + "' and familia='"+familia+"'";
               
               
               String query1 = "select barra,familia from productos WHERE barra='" + BuscarCod + "'";
               try {
                   //getting database connection to MySQL server 
                   //dbCon = DriverManager.getConnection(dbURL, username, password);
                   //getting PreparedStatment to execute query 
                   ...
                   rs1 = stmt1.executeQuery(query1);
                    while(rs1.next()){ 
                        fam=rs1.getString(2);
                         sheet.addCell(new jxl.write.Label(6, j, fam));
                    }
