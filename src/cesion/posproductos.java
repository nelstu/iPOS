...
public class posproductos extends javax.swing.JFrame {
   ...
   private void cargarDriver() {
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cesion/img/Delete.jpg"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     String Buscar= jTextField2.getText();
        ...
        try {
            ...
            comando.executeUpdate("DELETE FROM productos  WHERE barra='"+barra+"'");
