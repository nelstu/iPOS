...
WritableWorkbook workbook =Workbook.createWorkbook(new File("ejemplo.xls"));

//Se crea una nueva hoja dentro del libro
WritableSheet sheet =workbook.createSheet("HojaEjemplo", 0);
...
System.out.println("Error al escribir el fichero.");
  ...
  try {
                Desktop.getDesktop().open(new File("ejemplo.xls"));
